...
def read_config(config_file=common.ossec_conf):
    ...
    if isinstance(config_cluster['log_level'], str) and not config_cluster['log_level'].isdigit():
        raise WazuhException(3004, "Cluster log level must be an integer.")
    # cast log_level value to integer
